...
const Appointments = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    let today = new Date()
    let allSlots = []   // ✅ store all days slots
...
//Book Appointment
  ...
  return docInfo && (
    <div>
      ...
      {/* Doctor experience,image about etc.. */}
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2  sm:mx-0 mt-[-80px] sm:mt-0'>
          <p className='flex flex-row items-center gap-2 text-2xl font-medium text-gray-900 '>{docInfo.name} <img className='w-5' src={assets.verified_icon}/></p>
        ...
        <p className='text-gray-500 mt-4 font-medium'>Appointment fee: <span className="text-gray-600">{currencySymbol}{docInfo.fees}</span></p>
        </div>
        </div>
...
<div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
  ...
  <button onClick={bookAppointment} className='bg-primary text-sm text-white font-light py-3 px-14 mt-5 rounded-full'>Book an appointment</button>
</div>
